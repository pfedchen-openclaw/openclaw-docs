...
---
_Attachments for 6c.11: this closure + `SESSION-6c.11-OPENER.md` + `JUDGEMENT-DOCTRINE.md` + `6c11-BRIEF-EDITS-STAGED.md` + `PHASE-6-DEVIATIONS-LOG.md` (P6-67…P6-73) + `PRE-COS-BACKLOG.md`._
